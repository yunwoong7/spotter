...
MODEL_PATH = os.path.join(parentDir, _config["hed"]["model_path"])
PROTO_TXT_PATH = os.path.join(parentDir, _config["hed"]["proto_txt_path"])
...
class HED():
    ...
    def __init__(self):
        ...
        print('[HED] finished loading (%.4f sec)' % (time.time() - tstamp))
