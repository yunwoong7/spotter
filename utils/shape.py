...
from image_processing import distance, distancetoline
...
class Shape(object):
    ...
    def __init__(self, label=None, line_color=None, shape_type=None, flags=None, group_id=None):
        self.label = label
        ...
        self._highlightSettings = {self.NEAR_VERTEX: (4, self.P_ROUND),
        ...
        if self.points:
            ...
            if self.shape_type == "rectangle":
                ...
                if len(self.points) == 2:
                    ...
                    fill_font = QFont('맑은 고딕', 40)
                    fill_font.setBold(True)
                    painter.setFont(fill_font)
                    painter.drawText(rectangle, self.label, option=QTextOption(Qt.AlignCenter))
